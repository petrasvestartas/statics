...
void test_moment_varignon() {
    ...
    // Test case 2
    p = geo::Point(0.4+0.3*cos(45*geo::GLOBALS::TO_RAD), 0.3*sin(45*geo::GLOBALS::TO_RAD), 0);
    ...
    // Test case 3
    p = geo::Point(4+3*cos(45*geo::GLOBALS::TO_RAD)-1, 3*sin(45*geo::GLOBALS::TO_RAD), 0);
    v = geo::Vector(0, 600, 0);
    moment = geo::moment_varignon(p, v);
    my_assert(std::abs(moment - 3072.79220613578581833281) < geo::GLOBALS::ZERO_TOLERANCE);

    // Test case 4
    p = geo::Point(0.1+0.2*cos(45*geo::GLOBALS::TO_RAD)+0.1, 0.2*sin(45*geo::GLOBALS::TO_RAD), 0);
    v = geo::Vector(50*cos(60*geo::GLOBALS::TO_RAD), 50*sin(60*geo::GLOBALS::TO_RAD), 0);
    moment = geo::moment_varignon(p, v);
    my_assert(std::abs(moment - 11.2484) < 0.0001);

    // Test case 5
    p = geo::Point(2.5*cos(30*geo::GLOBALS::TO_RAD)-0.25*cos(60*geo::GLOBALS::TO_RAD), 2.5*sin(30*geo::GLOBALS::TO_RAD)+0.25*sin(60*geo::GLOBALS::TO_RAD), 0);
...
void test_sum_moment_varignon(){
    ...
    std::vector<geo::Point> points = {
        geo::Point(1, 0, 0), 
        geo::Point(3+2.5*cos(45*geo::GLOBALS::TO_RAD), 2.5*sin(45*geo::GLOBALS::TO_RAD), 0)
    };
    
    std::vector<geo::Vector> forces = {
        geo::Vector(0, -600, 0), 
        geo::Vector(300, 500, 0)
    };
    ...
    // Test case 2
    points = {
        geo::Point(0.125+0.3, 0.25, 0),
        geo::Point(0.125+0.3, 0.25, 0)
    };

    forces = {
        geo::Vector(0.8*500, 0.6*500, 0), 
        geo::Vector(cos(60*geo::GLOBALS::TO_RAD)*600, -sin(60*geo::GLOBALS::TO_RAD)*600, 0)
    };
    ...
    forces = {
        geo::Vector(-200, 0, 0), 
        geo::Vector(300*sin(30*geo::GLOBALS::TO_RAD), -300*cos(30*geo::GLOBALS::TO_RAD), 0)
    };
