...
void test_arc() {
    ...
    std::vector<geo::Point> expected_points = {
        geo::Point(-4.000000, 0.000000, 0.000000),
        geo::Point(-1.341217, 0.355424, 0.000000),
        geo::Point(-1.349202, 0.475424, 0.000000),
        geo::Point(-4.015900, 0.118942, 0.000000),
        geo::Point(-1.341217, 0.355424, 0.000000),
        geo::Point(1.341217, 0.355424, 0.000000),
        geo::Point(1.349202, 0.475424, 0.000000),
        geo::Point(-1.349202, 0.475424, 0.000000),
    ...
    for (auto polygon : polygons)
        for (auto p : polygon)
            my_assert(std::abs(p[0] - expected_points[counter][0]) < 0.0001 && std::abs(p[1] - expected_points[counter++][1]) < 0.0001);
