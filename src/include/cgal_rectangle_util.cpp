...
namespace cgal
{
    namespace rectangle_util
    {
        ...
        bool bounding_rectangle(CGAL_Polyline &polygon, CGAL_Polyline &result)
        {
            ...
            cgal::polyline_util::transform(polygon_copy, xform_to_xy);
        ...
        bool grid_of_points_in_a_polygon(CGAL_Polyline &polygon, const double &offset_distance, const double &division_distance, const int &max_points, std::vector<IK::Point_3> &points) // const double &divisions,
        {
            ...
            if (offset_distance != 0)
                collider::clipper_util::offset_in_2d(polygon_copy, offset_distance);
            ...
            if (polygon_copy.size() == 5)
            {
                ...
                cgal::vector_util::interpolate_points(polygon_copy[0], polygon_copy[1], divisions_u, division_points_edge_0, 1);
                cgal::vector_util::interpolate_points(polygon_copy[3], polygon_copy[2], divisions_u, division_points_edge_2, 1);
