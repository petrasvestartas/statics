...
namespace wood
{
    namespace joint_lib
    {
        ...
        void ss_e_ip_3(wood::joint &joint)
        {
            ...
            joint.f_boolean_type = {wood::cut::mill_project, wood::cut::mill_project, wood::cut::drill, wood::cut::drill, wood::cut::drill, wood::cut::drill};
            joint.m_boolean_type = {wood::cut::mill_project, wood::cut::mill_project, wood::cut::drill, wood::cut::drill, wood::cut::drill, wood::cut::drill};
        }
        ...
        void ss_e_ip_4(wood::joint &joint)
        {
            ...
            joint.f_boolean_type = {wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::drill, wood::cut::drill, wood::cut::drill, wood::cut::drill};
            joint.m_boolean_type = {wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::drill, wood::cut::drill, wood::cut::drill, wood::cut::drill};
        }
        ...
        void ss_e_op_4(wood::joint &joint, double t, bool chamfer, bool female_modify_outline, double x0, double x1, double y0, double y1, double z_ext0, double z_ext1) //
        {
            ...
            if (joint.divisions > 0)
                for (int i = 0; i < number_of_tenons; i += 2)
                {
                    joint.f_boolean_type[female_modify_outline_count + i] = wood::cut::hole;
                    joint.f_boolean_type[female_modify_outline_count + i + 1] = wood::cut::hole;
                }
        }
        ...
        void ss_e_r_0(wood::joint &jo, std::vector<wood::element> &elements)
        {
            ...
            jo.m_boolean_type = {wood::cut::slice, wood::cut::slice, wood::cut::slice, wood::cut::slice};
            jo.f_boolean_type = {wood::cut::slice, wood::cut::slice, wood::cut::slice, wood::cut::slice};
        }
        ...
        void side_removal_ss_e_r_1(wood::joint &jo, std::vector<wood::element> &elements, bool merge_with_joint)
        {
            ...
            if (merge_with_joint)
            {
                ...
                if (read_successful)
                {
                    ...
                    // wood::cut::conic_offset = 0.8440;
                    // printf("\n %f", wood::cut::conic_offset);
                    // printf("\n %f", wood::cut::conic_offset_opposite);
                    ...
                    for (int i = 0; i < joint_2.m[0].size(); i++)
                    {
                        ...
                        collider::clipper_util::offset_in_3d(joint_2.m[0][i], plane_0_0, offset_value); // 0.1 means more tighter
                        // double value = -(2 * wood::cut::conic_offset_opposite) - wood::cut::conic_offset;
                        // printf("reult %f ", offset_value);
                        //  printf("reult %f ", wood::cut::conic_offset);
                        // printf("reult %f ", wood::cut::conic_offset_opposite);
                        // printf("reult %f ", wood::cut::conic_offset +wood::cut::conic_offset_opposite);//shOULD BE THIS
                    }

                    for (int i = 0; i < joint_2.m[1].size(); i++)
                    {
                        // cgal_polyline_util::reverse_if_clockwise(joint_2.f[1][i], plane_0_0);
                        collider::clipper_util::offset_in_3d(joint_2.m[1][i], plane_0_0, offset_value);
                    }
                    ...
                    collider::clipper_util::get_intersection_between_two_polylines(jo.m[0][2], joint_2.m[0][0], plane_0_0, jo.m[0][2], 2);
                    collider::clipper_util::get_intersection_between_two_polylines(jo.m[1][2], joint_2.m[1][0], plane_0_1, jo.m[1][2], 2);
                    ...
                    for (auto &m : joint_2.m_boolean_type)
                        jo.m_boolean_type.emplace_back(wood::cut::conic);

                    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    // offset curve due to wood::cut::conic tool
                    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

                    for (int i = 0; i < joint_2.f[0].size(); i++)
                    {
                        // cgal_polyline_util::reverse_if_clockwise(joint_2.f[0][i], plane_0_0);
                        // collider::clipper_util::offset_in_3d(joint_2.f[0][i], plane_0_0, wood::cut::conic_offset_opposite);//- wood::cut::conic_offset
                    }

                    for (int i = 0; i < joint_2.f[1].size(); i++)
                    {
                        // collider::clipper_util::offset_in_3d(joint_2.f[1][i], plane_0_0, wood::cut::conic_offset_opposite);// - wood::cut::conic_offset
                    }
                    ...
                    for (auto &f : joint_2.f_boolean_type)
                        jo.f_boolean_type.emplace_back(wood::cut::mill);

                    jo.f[0].insert(jo.f[0].end(), joint_2.f[0].begin(), joint_2.f[0].end());
                    jo.f[1].insert(jo.f[1].end(), joint_2.f[1].begin(), joint_2.f[1].end());
                    for (auto &f : joint_2.f_boolean_type)
                        jo.f_boolean_type.emplace_back(wood::cut::conic_reverse);
                }
        ...
        void ss_e_r_2(wood::joint &joint, std::vector<wood::element> &elements)
        {
            ...
            std::vector<CGAL_Polyline> male_1 = {
                ...
                {IK::Point_3(0.2, -0.7, 0.166667),
                 IK::Point_3(-0.116667, -0.7, 0.166667),
                 IK::Point_3(-0.619628, -0.7, 0.375),
                 IK::Point_3(-1.0, -0.7, 0.375),
                 IK::Point_3(-1.0, -0.7, -0.375),
                 IK::Point_3(-0.619628, -0.7, -0.375),
                 IK::Point_3(-0.116667, -0.7, -0.166667),
                 IK::Point_3(0.2, -0.7, -0.166667),
            ...
            joint.key = joint.key + std::to_string(elements[joint.v0].id) + "_" + std::to_string(elements[joint.v1].id);
...
#ifdef DEBUG_JOINERY_LIBRARY
            printf("\nCPP <<File>> wood::joint_library.h <<Method>> ts_e_p_3 <<Description>> Joint Main Parameters");
#endif
...
#ifdef DEBUG_JOINERY_LIBRARY
            printf("\nCPP <<File>> wood::joint_library.h <<Method>> ts_e_p_3 <<Description> Interpolate Points");
#endif
...
#ifdef DEBUG_JOINERY_LIBRARY
            printf("\nCPP <<File>> wood::joint_library.h <<Method>> ts_e_p_3 <<Description> Move Segments");
#endif
...
#ifdef DEBUG_JOINERY_LIBRARY
            printf("\nCPP <<File>> wood::joint_library.h <<Method>> ts_e_p_3 <<Description> Create Polylines");
#endif
        }
        ...
        void ts_e_p_4(wood::joint &joint)
        {
            ...
            joint.f_boolean_type = {wood::cut::mill, wood::cut::mill, wood::cut::mill, wood::cut::mill, wood::cut::mill, wood::cut::mill, wood::cut::mill, wood::cut::mill};
            joint.m_boolean_type = {
                wood::cut::mill_project,
                wood::cut::mill_project,
                wood::cut::mill_project,
                wood::cut::mill_project,
                wood::cut::mill_project,
        ...
        void ts_e_p_5(wood::joint &joint)
        {
            ...
            std::vector<wood::cut::cut_type> male_types{
                wood::cut::edge_insertion,
                wood::cut::edge_insertion};
            ...
            std::vector<wood::cut::cut_type> female_types{
                wood::cut::hole,
                wood::cut::hole};
        ...
        void cr_c_ip_1(wood::joint &joint)
        {
            ...
            joint.f_boolean_type = {
                wood::cut::mill_project, wood::cut::mill_project,
                wood::cut::mill_project, wood::cut::mill_project,
                wood::cut::mill_project, wood::cut::mill_project,
                wood::cut::slice, wood::cut::slice,
                wood::cut::slice, wood::cut::slice,
                wood::cut::slice, wood::cut::slice,
                wood::cut::slice, wood::cut::slice,
        ...
        void cr_c_ip_2(wood::joint &joint)
        {
            ...
            joint.f[0] = {
                ...
                // {IK::Point_3(0.3, 0.041421, -0.928477), IK::Point_3(0.041421, 0.3, 0.928477)},     // wood::cut::drill line
                // {IK::Point_3(-0.3, -0.041421, -0.928477), IK::Point_3(-0.041421, -0.3, 0.928477)}, // wood::cut::drill line
        ...
        void cr_c_ip_5(wood::joint &joint)
        {
            ...
            joint.f[0] = {
                ...
                //{IK::Point_3(0, 1, 1), IK::Point_3(0, -1, 1)},     // wood::cut::drill line (smaller element)
        ...
        void tt_e_p_0(wood::joint &joint, std::vector<wood::element> &elements) //
        {
            ...
            joint.m_boolean_type = {wood::cut::drill, wood::cut::drill};
            joint.f_boolean_type = {wood::cut::drill, wood::cut::drill};
        ...
        void tt_e_p_2(wood::joint &joint, std::vector<wood::element> &elements) //
        {
            ...
            cgal::inscribe_util::get_polylabel_circle_division_points(IK::Vector_3(0, 0, 0), {joint.joint_area}, points, number_of_points, scale, 1.0, true); //  joint.divisions, joint.shift 6, 0.75, 1.0, true
            ...
            for (auto &point : points)
            {
                ...
                joint.m[1].emplace_back(line1);
                joint.m_boolean_type.emplace_back(wood::cut::drill);
                joint.m_boolean_type.emplace_back(wood::cut::drill);
                joint.f_boolean_type.emplace_back(wood::cut::drill);
                joint.f_boolean_type.emplace_back(wood::cut::drill);
            }
        ...
        void tt_e_p_5(wood::joint &joint, std::vector<wood::element> &elements) //
        {
            ...
            double precision = 1;
            cgal::inscribe_util::inscribe_rectangle_in_convex_polygon({joint.joint_area}, polygon_inscribed_rectangle, points, segment, scale, precision, division_length);
            ...
            // joint.f[1].emplace_back(polygon_inscribed_rectangle);
            // joint.f_boolean_type.emplace_back(wood::cut::mill);
            // joint.f_boolean_type.emplace_back(wood::cut::mill);
            for (auto &point : points)
            {
                // create polyline segments that represents the drilling holes
        ...
        void b_0(wood::joint &joint)
        {
            ...
            // printf("Hi");
            joint.m_boolean_type = {wood::cut::slice, wood::cut::slice, wood::cut::slice, wood::cut::slice};
        ...
        void construct_joint_by_index(std::vector<wood::element> &elements, std::vector<wood::joint> &joints, std::vector<double> &default_parameters_for_four_types, std::vector<double> &scale)
        {
            ...
            joint_names[5] = "ss_e_ip_4";
            joint_names[6] = "ss_e_ip_5";
            ...
            for (auto &jo : joints)
            {
                ...
                // a) by wood::globals, when the scale input is empty
                // b) by user
                ...
                {
                    // std::cout << "wood::joint_lib -> skipping joint \n";
