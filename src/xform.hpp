...
namespace geo
{
    ...
    public:
        ...
        static std::vector<geo::Point> apply(const Matrix& transform, const std::vector<geo::Point>& points);

        // Static method to apply transformation to an array of points
        template <std::size_t N>
        static std::array<geo::Point, N> apply(const Matrix& transform, const std::array<geo::Point, N>& points);
