...
namespace geo
{
    ...
    Matrix Xform::change_basis(
        geo::Point& origin_1, geo::Vector& x_axis_1, geo::Vector& y_axis_1, geo::Vector& z_axis_1,
        geo::Point& origin_0, geo::Vector& x_axis_0, geo::Vector& y_axis_0, geo::Vector& z_axis_0) {
    ...
    Matrix Xform::plane_to_plane(
        geo::Point& origin_0,  geo::Vector& x_axis_0,  geo::Vector& y_axis_0,
        ...
        Matrix f0(4, 4);
        f0(0, 0) = _x_axis_0[0]; f0(0, 1) = _x_axis_0[1]; f0(0, 2) = _x_axis_0[2];
        f0(1, 0) = _y_axis_0[0]; f0(1, 1) = _y_axis_0[1]; f0(1, 2) = _y_axis_0[2];
        f0(2, 0) = _z_axis_0[0]; f0(2, 1) = _z_axis_0[1]; f0(2, 2) = _z_axis_0[2];
        f0(3, 3) = 1.0;

        Matrix f1(4, 4);
        f1(0, 0) = _x_axis_1[0]; f1(0, 1) = _y_axis_1[0]; f1(0, 2) = _z_axis_1[0];
        f1(1, 0) = _x_axis_1[1]; f1(1, 1) = _y_axis_1[1]; f1(1, 2) = _z_axis_1[1];
        f1(2, 0) = _x_axis_1[2]; f1(2, 1) = _y_axis_1[2]; f1(2, 2) = _z_axis_1[2];
        f1(3, 3) = 1.0;
    ...
    Matrix Xform::plane_to_xy( geo::Point& origin,  geo::Vector& x_axis,  geo::Vector& y_axis) {
        ...
        geo::Vector z_axis = y_axis.cross(x_axis);
        ...
        Matrix f(4, 4);
        f(0, 0) = _x_axis[0]; f(0, 1) = _x_axis[1]; f(0, 2) = _x_axis[2];
        f(1, 0) = _y_axis[0]; f(1, 1) = _y_axis[1]; f(1, 2) = _y_axis[2];
        f(2, 0) = _z_axis[0]; f(2, 1) = _z_axis[1]; f(2, 2) = _z_axis[2];
        f(3, 3) = 1.0;
    ...
    Matrix Xform::xy_to_plane( geo::Point& origin,  geo::Vector& x_axis,  geo::Vector& y_axis) {
        ...
        Matrix f(4, 4);
        f(0, 0) = _x_axis[0]; f(0, 1) = _y_axis[0]; f(0, 2) = _z_axis[0];
        f(1, 0) = _x_axis[1]; f(1, 1) = _y_axis[1]; f(1, 2) = _z_axis[1];
        f(2, 0) = _x_axis[2]; f(2, 1) = _y_axis[2]; f(2, 2) = _z_axis[2];
        f(3, 3) = 1.0;
    ...
    std::vector<geo::Point> Xform::apply(const Matrix& transform, const std::vector<geo::Point>& points) {
    ...
    std::array<geo::Point, N> Xform::apply(const Matrix& transform, const std::array<geo::Point, N>& points) {
    ...
    template std::array<geo::Point, 2> Xform::apply(const Matrix& transform, const std::array<geo::Point, 2>& points);
    template std::array<std::array<geo::Point, 2>, 2> Xform::apply(const Matrix& transform, const std::array<std::array<geo::Point, 2>, 2>& points);
    template std::vector<std::vector<geo::Point>> Xform::apply(const Matrix& transform, const std::vector<std::vector<geo::Point>>& points);
